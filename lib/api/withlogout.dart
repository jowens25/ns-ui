...
class RouteConfig {
  ...
  const RouteConfig({
    ...
    this.children = const [],
    this.isAllowed = true,
    this.requiresAuth = true, // Most routes require authentication
  });
}
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (!isAuthenticated &&
          AppRoutes.requiresAuthentication(state.uri.path)) {
        return '/login';
      }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Please sign in to access the explorer',
...
class _ExplorerLayoutState extends State<ExplorerLayout> {
  ...
  void initState() {
    ...
    // Listen to auth changes to update explorer items
                          ...
                          ? Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 16),
                                Text(
                                  'Please log in to view explorer items',
                                  style: Theme.of(
                                    context,
