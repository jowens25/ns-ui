...
# busctl call        com.example.SampleInterface0 /com/example/sample0 org.freedesktop.DBus.Introspectable Introspect
# busctl --user call com.example.name             /com/example/sample0 com.example.SampleInterface0 \
# busctl --user call com.example.name /com/example/sample0 com.example.SampleInterface0 Introspect
